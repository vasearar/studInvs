...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Crearea unui post</h1>
    </div>
    ...
    <div class="col-lg-9">
        <form action="/dashboard/posts" method="post" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="title" class="form-label">Titlul</label>
            ...
            <div class="mb-3">
                <label for="slug" class="form-label">Lozingul</label>
            ...
            <div class="mb-3">
                <label for="image" class="form-label">Imaginea postării</label>
            ...
            <div class="mb-3">
                <label for="content" class="form-label">Contentul</label>
            ...
            <button type="submit" class="btn btn-success mt-3">Crează postul</button>
        </form>
    </div>
