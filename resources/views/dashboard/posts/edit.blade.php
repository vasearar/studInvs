...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Editarea postului</h1>
    </div>
    ...
    <div class="col-lg-9">
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data" class="mb-5">
            ...
            <div class="mb-3">
                <label for="image" class="form-label">Imaginea postului</label>

                <input type="hidden" name="oldImg" value="{{ $post->image }}">
                
                @if ($post->image) <img src="{{ asset('' . $post->image) }}" class="img-preview img-fluid mb-3 mt-1 d-block" style="max-height: 300px; overflow: auto">
            ...
            <button type="submit" class="btn btn-success mt-3">Editează postul</button>
        </form>
    </div>
