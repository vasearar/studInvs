...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Crearea unei noi categorii</h1>
    </div>
    ...
    <div class="col-lg-9">
        <form action="/dashboard/categories" method="post" class="mb-5">
            ...
            <div class="mb-3">
              <label for="name" class="form-label">Denumirea categoriei</label>
            ...
            <button type="submit" class="btn btn-success mt-3">Crează o categorie</button>
        </form>
    </div>
