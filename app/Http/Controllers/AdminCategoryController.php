...
class AdminCategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect('/dashboard/categories')->with('success', "Cu succes ati schimbat '" . $category->name . "'!");
    }
    ...
    public function destroy(Category $category)
    {
        ...
        return redirect('/dashboard/categories')->with('success', "Cu succes ati schimbat '" . $categoryName . "'!");
    }
